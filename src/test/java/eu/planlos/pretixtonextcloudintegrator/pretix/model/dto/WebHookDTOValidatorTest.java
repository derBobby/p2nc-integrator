...
class WebHookDTOValidatorTest {
    ...
    public void allMembersOK_noExceptionThrown() {
        // Prepare
        //      objects
        WebHookDTO webHookDTO = new WebHookDTO(0L, "some-organizer", "some-event", "XC0DE", SupportedActions.ORDER_APPROVED.getAction());
    ...
    public void organizerContainsSpecialChars_throwsException() {
        // Prepare
        //      objects
        WebHookDTO webHookDTO = new WebHookDTO(0L, "<script>alert(\"X\")</script>", "some-event", "XC0DE", SupportedActions.ORDER_APPROVED.getAction());
        //      methods
    ...
    public void organizerExceedsChars_throwsException() {
        // Prepare
        //      objects
        WebHookDTO webHookDTO = new WebHookDTO(0L, "0123456789012345678901234567891", "some-event", "XC0DE", SupportedActions.ORDER_APPROVED.getAction());
        //      methods
    ...
    public void eventContainsSpecialChars_throwsException() {
        // Prepare
        //      objects
        WebHookDTO webHookDTO = new WebHookDTO(0L, "organizer", "<script>alert(\"X\")</script>", "XC0DE", SupportedActions.ORDER_APPROVED.getAction());
        //      methods
    ...
    public void eventExceedsChars_throwsException() {
        // Prepare
        //      objects
        WebHookDTO webHookDTO = new WebHookDTO(0L, "organizer", "0123456789012345678901234567891", "XC0DE", SupportedActions.ORDER_APPROVED.getAction());
        //      methods
    ...
    public void codeContainsSpecialChars_throwsException() {
        // Prepare
        //      objects
        WebHookDTO webHookDTO = new WebHookDTO(0L, "organizer", "some-event", "{<?>}", SupportedActions.ORDER_APPROVED.getAction());
        //      methods
    ...
    public void codeExceedsChars_throwsException() {
        // Prepare
        //      objects
        WebHookDTO webHookDTO = new WebHookDTO(0L, "organizer", "some-event", "123456", SupportedActions.ORDER_APPROVED.getAction());
        //      methods
