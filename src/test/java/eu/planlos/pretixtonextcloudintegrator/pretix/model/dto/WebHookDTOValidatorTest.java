//TODO implement in PretixWebhookControllerTest.java
...
//        // Prepare
//        //      objects
//        WebHookDTO webHookDTO = new WebHookDTO(0L, "some-organizer", "some-event", "XC0DE", PretixSupportedActions.ORDER_APPROVED.getAction());
...
//        // Prepare
//        //      objects
//        WebHookDTO webHookDTO = new WebHookDTO(0L, "<script>alert(\"X\")</script>", "some-event", "XC0DE", PretixSupportedActions.ORDER_APPROVED.getAction());
//        //      methods
//
//        // Act
//        // Check
...
//        // Prepare
//        //      objects
//        WebHookDTO webHookDTO = new WebHookDTO(0L, "0123456789012345678901234567891", "some-event", "XC0DE", PretixSupportedActions.ORDER_APPROVED.getAction());
//        //      methods
//
//        // Act
//        // Check
...
//        // Prepare
//        //      objects
//        WebHookDTO webHookDTO = new WebHookDTO(0L, "organizer", "<script>alert(\"X\")</script>", "XC0DE", PretixSupportedActions.ORDER_APPROVED.getAction());
//        //      methods
//
//        // Act
//        // Check
...
//        // Prepare
//        //      objects
//        WebHookDTO webHookDTO = new WebHookDTO(0L, "organizer", "0123456789012345678901234567891", "XC0DE", PretixSupportedActions.ORDER_APPROVED.getAction());
//        //      methods
//
//        // Act
//        // Check
...
//        // Prepare
//        //      objects
//        WebHookDTO webHookDTO = new WebHookDTO(0L, "organizer", "some-event", "{<?>}", PretixSupportedActions.ORDER_APPROVED.getAction());
//        //      methods
//
//        // Act
//        // Check
...
//        // Prepare
//        //      objects
//        WebHookDTO webHookDTO = new WebHookDTO(0L, "organizer", "some-event", "123456", PretixSupportedActions.ORDER_APPROVED.getAction());
//        //      methods
//
//        // Act
//        // Check
